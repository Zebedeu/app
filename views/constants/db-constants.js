...
module.exports = { 
    dbSchema: {
        ...
        farmers:'Farmer',
        orders:'Order',
        mobile_country_codes:'Mobile_country_code',
        withdraw_requests:'WithDraw_Request',
        locked_amounts:'Locked_amount',
        references:'Reference',
        product_farmer_aggregator: 'product_farmer_aggregator',
        famer_and_aggregator: 'famer_and_aggregator'
    }
};