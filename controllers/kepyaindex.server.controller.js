...
exports.kepyaIndex = function (req, res) {
	...
	res.render('kepyaindex', {
		...
		labels,
		moment,
		breadcrumb: "<li class='breadcrumb-item'><a href='" + config.base_url + req.session.user_type+"/dashboard'>" + labels['LBL_HOME'][(req.session.language || config.default_language_code)] + "</a></li><li class='breadcrumb-item active' aria-current='page'>" + labels['LBL_KEPYA_INDEX'][(req.session.language || config.default_language_code)] + "</li>",
